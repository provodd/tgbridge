...
data class MessagesConfig(
    ...
    @YamlComment(
        ...
        "See https://tgbridge.vanutp.dev/en/localization for details.",
        "Default value: null (disabled)",
        "",
        // Thanks to BlueMap https://github.com/BlueMap-Minecraft/BlueMap/blob/9b8c86ec2903ecbcaee897ef4cde74f147dc2bef/common/src/main/resources/de/bluecolored/bluemap/config/core.conf
        "By changing this option you are indicating that you have accepted Mojang's EULA (https://aka.ms/MinecraftEULA),",
    ...
    val autoMessagesLanguage: String? = null,
)
